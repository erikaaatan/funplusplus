ABOUT PROJECT
This project is an improvement on the fun language. We've added several different types of data structures, 
a string type, and generally improved performance. 
